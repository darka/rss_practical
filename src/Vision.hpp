...
class Vision{
    ...
    public:
        ...
        void static segment_floor( 
                IplImage* src,
                IplImage* dst,
                int*      odv );

        inline void static interpolatedCoordinates( 
                int &min_x,
                int &min_y,
                int &max_x,
                int &max_y,
        ...
        inline static bool boxIsCentered( 
                int image_center_x,
                int image_center_y,
                int box_center_x,
                int box_center_y );
